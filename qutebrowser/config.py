...
c.fonts.web.family.fixed = 'JetBrains Mono NL'
c.fonts.web.family.sans_serif = 'JetBrains Mono NL'
c.fonts.web.family.serif = 'JetBrains Mono NL'
c.fonts.web.family.standard = 'JetBrains Mono NL'
...
config.bind('zo', 'spawn --userscript qute-bitwarden --totp')
