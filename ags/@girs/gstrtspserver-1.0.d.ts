...
declare module 'gi://GstRtspServer?version=1.0' {
    // Module dependencies
    import type GstRtsp from 'gi://GstRtsp?version=1.0';
    ...
    import type GstNet from 'gi://GstNet?version=1.0';
    ...
    export namespace GstRtspServer {
        ...
        class RTSPAddressPool extends GObject.Object {
            ...
            emit<K extends keyof RTSPAddressPool.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPAddressPool.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
        ...
        class RTSPMediaFactory extends GObject.Object {
            ...
            emit<K extends keyof RTSPMediaFactory.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPMediaFactory.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RTSPMountPoints extends GObject.Object {
            ...
            emit<K extends keyof RTSPMountPoints.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPMountPoints.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RTSPOnvifClient extends RTSPClient {
            ...
            emit<K extends keyof RTSPOnvifClient.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPOnvifClient.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RTSPOnvifMediaFactory extends RTSPMediaFactory {
             ...
             * @param media a #GstRTSPOnvifMedia
             * @param ctx a #GstRTSPContext
             */
        ...
        class RTSPOnvifServer extends RTSPServer {
            ...
            emit<K extends keyof RTSPOnvifServer.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPOnvifServer.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RTSPSessionMedia extends GObject.Object {
            ...
            emit<K extends keyof RTSPSessionMedia.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPSessionMedia.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class RTSPSessionPool extends GObject.Object {
            ...
            emit<K extends keyof RTSPSessionPool.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<RTSPSessionPool.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
